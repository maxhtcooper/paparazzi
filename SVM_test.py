...
print("\n--- Copy these arrays into your Paparazzi C module ---")
print(f"const float scaler_mean[3] = {{{scaler.mean_[0]:.6f}, {scaler.mean_[1]:.6f}, {scaler.mean_[2]:.6f}}};")
print(f"const float scaler_scale[3] = {{{scaler.scale_[0]:.6f}, {scaler.scale_[1]:.6f}, {scaler.scale_[2]:.6f}}};")
print(f"const float svm_weights[3] = {{{clf.coef_[0][0]:.6f}, {clf.coef_[0][1]:.6f}, {clf.coef_[0][2]:.6f}}};")
print(f"const float svm_intercept = {clf.intercept_[0]:.6f};")
